...
# WEIEIIGHGHGHTITTTING
# Hue matters more than value and saturation here
HUE_GATE  = 15.0
...
# device setup according to hwat the user has
...
while True:
    ...
    cv2.imshow("proj", annotated_frame)
